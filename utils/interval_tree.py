...
class Node:
    def __init__(self, mark_value, min_value, max_value, color, parent, left=None, right=None, isEdge=False):
        ...
        self.id = str(int(self.min_value * 100)) + str(int(self.max_value * 100))
...
class RedBlackTree:
    ...
    def insert_node(self, value):
        if not self.root:
            ...
            self.root = Node(mark_value=value, max_value=new_max_value, min_value=new_min_value, color=BLACK,
                             parent=None, left=self.NIL_LEAF, right=self.NIL_LEAF)
            self.count += 1
        ...
        if node_dir == 'L':
            new_node = Node(mark_value=value, max_value=new_max_value, min_value=new_min_value, color=RED,
                            parent=parent,
