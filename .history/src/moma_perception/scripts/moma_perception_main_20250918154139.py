...
class MomaPerception:
    ...
    def moma_cmd_publish_from_action(self, action):
        ...
        msg = moma_cmd()
        msg.header.stamp = rospy.Time.now()
        msg.data = np.array([curr_base[0],curr_base[1],delta_ee_pos[0],delta_ee_pos[1],delta_ee_pos[2],delta_ee_pos[3],delta_ee_pos[4],delta_ee_pos[5],gripper_state],dtype=float)
