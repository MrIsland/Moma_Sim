...
class MomaController:
    ...
    def _set_arm_delta_ee_pos(self, delta_ee_pos):
        ...
        curr_pos,curr_quat = self.ik_arm_controller.get_ee_pos_quat_from_pybullet(curr_joint_state)
    ...
    def _get_state(self):
        ...
        curr_pos,curr_orn = self.ik_arm_controller.get_ee_pos_rpy_from_pybullet(joint_state)
