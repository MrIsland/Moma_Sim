...
class MomaController:
    ...
    def _get_image(self):
        # 确保 MuJoCo 状态更新
        print('_get_image       1111111111111')
        self.cam_viewer.make_context_current()
        print('_get_image       2222222222222')
        ...
        print('_get_image       3333333333333')
        seg = self.cam_viewer.render(
            render_mode='rgbd_tuple', camera_id=0, segmentation=True
        )
        print('type:  rgb:    {}; depth:    {}; seg:     {}'.format(type(rgb), type(depth), type(seg)))
