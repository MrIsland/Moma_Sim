...
class MomaController:
    ...
    def _move_arm(self, delta_ee_pos):
        ...
        rospy.loginfo('id(self.sync_pub.joint_state_data):     {}'.format(id(self.sync_pub.joint_state_data)))
        rospy.loginfo('id(self.robot_date.qpos):     {}'.format(id(self.robot_data.qpos[self.robot_data.qpos[self.arm_joint_ids]])))
