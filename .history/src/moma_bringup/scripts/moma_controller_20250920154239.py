...
class MomaController:
    ...
    def _move_arm(self, delta_ee_pos):
        ...
        rospy.loginfo('self.arm_joint_state:      {}'.format(self.arm_joint_state))
        ...
        # self.robot_data.qpos[self.arm_joint_ids] = np.array([-0.670000, 0.000000, 0.800000, 0.000000, 1.360000, 3.140000])
