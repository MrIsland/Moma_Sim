...
class SyncAndPublish:
    ...
    def publish_synced_msg(self, event):
        try:
            # print('publish   11111111111111111111111111111111111')
            self.joint_state_data, self.rgb_data, self.depth_data, self.chassis_vel, self.odometry_data, self.ee_pos\
            ...
            # print('self.rgb_data:              {}'.format(type(self.rgb_data)))
            # print('self.depth_data:            {}'.format(type(self.depth_data)))
            # print('publish   22222222222222222222222222222222222')
            ...
            if self.ee_pos is not None:
                epos_in_lidar = self.pose_computer.compute(self.ee_pos)
