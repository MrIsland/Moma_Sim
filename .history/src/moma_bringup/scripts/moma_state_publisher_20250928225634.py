...
class ComputeEposeInLidarFrame:
    def __init__(self):
        ...
        # pos:   [0, 0, 0.16]  quat:   [0.707, -0.001, 0.707, 0.001]
        self.T_arm_ee_pos2gripper_site = np.array([
            [0.00000, 0.00000, 1.00000, 0.00000], 
            [0.00000, -1.00000, 0.00000, 0.00000], 
            [1.00000, 0.00000, 0.00000, 0.16000], 
            [0.00000, 0.00000, 0.00000, 1.00000]
        ])
    ...
    def quat_to_matrix(self, quat):
        tx, ty, tz, qw, qx, qy, qz = quat[0], quat[1], quat[2], quat[3], quat[4], quat[5], quat[6]
        tmp_quat = np.array([tx, ty, tz, qx, qy, qz, qw])
        rot = R.from_quat(tmp_quat[3:]).as_matrix()
        T = np.eye(4)
        T[:3, :3] = rot
    ...
    def compute_epos_in_lidar(self, ee_pose):
        ...
        return T_epos_in_lidar @ self.T_arm_ee_pos2gripper_site
    ...
    def compute_epos_in_base(self, ee_pose):
        ...
        return T_epos_in_base @ self.T_arm_ee_pos2gripper_site
