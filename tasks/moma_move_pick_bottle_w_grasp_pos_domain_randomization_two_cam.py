...
from utils.common import random_z_rotation_quaternion, mov, pose_to_matrix, pose_to_matrix_batch, \
    rotmat_to_euler_xyz_batch, opengl_trans_opencv, get_quat_180, pre_process_rgb_img
...
class MomaMovePickBottleWGraspPosDRTwoCam(VecTask):
    ...
    def grasp_pos_extraction(self, valid_grasp_pos_num=64):
        ...
        for i in range(self.num_envs):
            ...
            # frame_cloud = self.grasp_pose_factories[i].add_new_frame(self.curr_frame_pcd[i], self.curr_frame_valid[i], i, target_label=self.segmentation_id['bottleA'])
    ...
    def pre_physics_step(self, actions):
        ...
        # currnet_base_pos_ = self.move_base_position(u_wheel)
